...
@OpenAPIDefinition(
        info = @Info(
                ...
                version = "1.0",
                description = "Service REST pour gérer les utilisateurs : inscription, connexion et génération de tokens JWT.",
                contact = @Contact(
        ...
        servers = {
                @Server(url = "/api/auth", description = "Serveur principal d'authentification")
        },
        security = {
...
public class SwaggerConfig {
    ...
    public OpenAPI customizeOpenAPI() {
        // ✅ Use fully-qualified class names to avoid annotation/model conflicts
